...
@Component({
    selector: 'ngbd-modal-addCategoriesInvestiments',
    templateUrl: './addCategoriesInvestiments.html',
    styleUrls: ['./addCategoriesInvestiments.css'],
    // add NgbModalConfig and NgbModal to the component providers
    providers: [NgbModalConfig, NgbModal]
})
export class NgbdModaladdCategoriesInvestiments {
