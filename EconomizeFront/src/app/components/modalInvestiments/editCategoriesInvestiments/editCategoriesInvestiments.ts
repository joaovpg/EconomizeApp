...
@Component({
    selector: 'ngbd-modal-editCategoriesInvestiments',
    templateUrl: './editCategoriesInvestiments.html',
    styleUrls: ['./editCategoriesInvestiments.css'],
    // add NgbModalConfig and NgbModal to the component providers
    providers: [NgbModalConfig, NgbModal]
})
export class NgbdModaleditCategoriesInvestiments implements OnInit {
