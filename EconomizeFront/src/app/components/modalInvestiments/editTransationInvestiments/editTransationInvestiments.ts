...
@Component({
    selector: 'ngbd-modal-editTransationInvestiments',
    templateUrl: './editTransationInvestiments.html',
    styleUrls: ['./editTransationInvestiments.css'],
    // add NgbModalConfig and NgbModal to the component providers
    providers: [NgbModalConfig, NgbModal]
})
export class NgbdModalEditTransationInvestiments implements OnInit {
    closeResult = '';
    transation: TransationsModel = new TransationsModel();
    accountArray: Array<any> = new Array();
    categoryArray: Array<any> = new Array();

    constructor(config: NgbModalConfig, private modalService: NgbModal, private getSet: GetSetService, private transations: InvestimentService, private account: BankAccountsService, private categories: CategoriesService) {
